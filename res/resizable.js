...
Resizable.prototype = {
  initialize: function(element) {
    var defaults = {
      ...
      endeffect: function(element) {
        ...
        var effTemp = new Effect.Opacity(element, {duration:0.2, from:0.7, to:toOpacity, 
    ...
    if(!arguments[1] || typeof arguments[1].endeffect == 'undefined'){
      Object.extend(defaults, {
        starteffect: function(element) {
          ...
          var effff = new Effect.Opacity(element, {duration:0.2, from:element._opacity, to:0.7}); 
        }
      });
	}
   ...
   reverteffect: function(element, horizontal, vertical) {
       var horiz = this._edim[0] - horizontal;
        ...
        var eff1 = new Effect.ReSize(element, {direction:'vert', amount:vert});
        var eff2 = new Effect.ReSize(element, {direction:'horizontal', amount:horiz});
    },
  ...
  startResize: function(event) {
    ...
    if(this.options.ghosting) {
      ...
      if(navigator.appName.indexOf('Microsoft') != -1 && parseInt(Element.getStyle(this.element, 'margin-top'),10) > 0){
...
Object.extend(Object.extend(Effect.ReSize.prototype, Effect.Base.prototype), {
  initialize: function(element) {
    ...
    if( options.direction == 'vert' ){
      this.originalSize = options.originalSize || parseInt(this.element.style.height,10);}
    else{
      this.originalSize = options.originalSize || parseInt(this.element.style.width,10);}
